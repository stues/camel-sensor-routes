...
public class TrackPositionMessage extends GeoJSONFeature {
	...
	private static String HEX_PROPERTY_NAME = "hex";
	private static String CALLSIGN_PROPERTY_NAME = "callsign";
	private static String ALTITUDE_PROPERTY_NAME = "altitude";
	private static String TRACK_PROPERTY_NAME = "track";
	private static String GROUND_SPEED_NAME = "groundSpeed";
	private static String IS_ON_GROUND_PROPERTY_NAME = "isOnGround";
